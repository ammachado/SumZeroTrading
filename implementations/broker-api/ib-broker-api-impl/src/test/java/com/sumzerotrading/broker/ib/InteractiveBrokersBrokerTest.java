...
public class InteractiveBrokersBrokerTest {
    ...
    public void testOrderStatus_NonCompletedOrder() throws Exception {
        ...
        OrderEvent expectedEvent = OrderManagmentUtil
            .createOrderEvent(order, status, filled, remaining, averageFilPrice, permId, parentId, lastFillPrice, clientId, whyHeld, now);
